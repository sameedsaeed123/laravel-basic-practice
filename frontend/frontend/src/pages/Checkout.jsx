...
export default function Checkout() {
    ...
    const selectionsComplete = (!needsColor || selectedColor) && (!needsSize || selectedSize);

    const handleCheckout = async () => {
        if (!selectionsComplete) {
            setError('Please select ' + [needsColor && !selectedColor ? 'a color' : '', needsSize && !selectedSize ? 'a size' : ''].filter(Boolean).join(' and ') + ' before checkout.');
            return;
        }
        setError('');
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm p-6">
                            ...
                            <button
                                ...
                                disabled={checkoutLoading || !selectionsComplete}
